...
**Date:** 2026-04-19  
**Author / main idea generator:** @NikolayS (Nik Samokhvalov)  
...
|---------|------------|-----------|---------|
| 0.1     | 2026-04-15 | @NikolayS (Nik Samokhvalov) | Initial draft. Consolidated own design with @x4m architectural input (Postgres.tv hacking session) + research on PG community history (Craig Ringer 2020, Kukushkin 2025 revival, PG16–19 infrastructure). Three-phase PoC plan. |
...
13. @x4m (Andrey Borodin), Postgres.tv hacking session — architectural input for this PoC (transcript in project files)
