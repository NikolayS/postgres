...
#define CONFIGURE_ARGS " '--enable-debug' '--without-icu'"
...
#define PG_VERSION_STR "PostgreSQL 18beta1 on aarch64-apple-darwin24.3.0, compiled by Apple clang version 17.0.0 (clang-1700.0.13.3), 64-bit"
